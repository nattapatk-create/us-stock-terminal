...
/* ============================================================
   ...
   จากนั้นตัวสแกนจะกรองอีกชั้นด้วยเกณฑ์ "หุ้นเทรนด์ขาขึ้น" จากราคา/ปริมาณซื้อขายรายวันจริง (ดู
   computeTechnicalSignal ด้านล่าง): Volume Surge เทียบค่าเฉลี่ย 20 วัน + ราคาอยู่เหนือ MA20/MA50
   พร้อมโมเมนตัมต่อเนื่อง 1-4 สัปดาห์ จากนั้นเสริมคะแนนด้วยกระแสข่าว (Finnhub company-news) และ
   แนวโน้มพื้นฐาน (Revenue/EPS Growth)
   ============================================================ */
