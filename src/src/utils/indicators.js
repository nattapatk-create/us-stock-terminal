...
// เดิมใช้ดึงแท่งราคารายวันสำหรับตัวสแกนหุ้นแนะนำ (Volume/MA/โมเมนตัมราคา) — เกณฑ์ชุดนั้นถูก
// โละทิ้งไปแล้ว (ดู recommendationScan.js — เกณฑ์ปัจจุบัน "Hypergrowth VI" ใช้เฉพาะตัวเลขงบการเงิน/
// มูลค่าจาก Finnhub /stock/metric ไม่ต้องดึงแท่งราคาเลย) คงค่าคงที่นี้ไว้เผื่อนำกลับมาใช้ในอนาคต
